    ...
    >
      <View style={modalStyles.modalContainer}>
        <View style={modalStyles.qrContainer}>
          {loading ? (
           ...
           { !device || !hasPermission ?(
                <View>
                    <Image style = {modalStyles.noCameraImage}
                     source={require('../../assets/images/no_camera.png')}/>
                </View>
            ) : (
                <View>
                    <Camera style = {modalStyles.camera}
                    isActive = {visible}
                    device={device}
        ...
        <CustomText style={modalStyles.infoText1}>
          Ensure you're on the same wi-fi network,</CustomText>
          <CustomText style={modalStyles.infoText2}>
            Ask the reciever to show a QR code to connect and transfer files.
          </CustomText>
